...
description: AWS Amplify Gen 2 Custom Resources for extending backends with AWS CDK. Use this when adding AWS services beyond built-in Amplify domains, always preferring Amplify-native resources where possible.
